...
class TestDefaultSignUpFlow(BaseTest):
    ...
    def test_website_qr_code_create(self, browser,  sign_up_fixture):
    ...
    def test_pdf_qr_code_create(self, browser,  sign_up_fixture):
    ...
    def test_links_qr_code_create(self, browser,  sign_up_fixture):
    ...
    def test_vcard_qr_code_create(self, browser,  sign_up_fixture):
    ...
    def test_business_qr_code_create(self, browser,  sign_up_fixture):
    ...
    def test_images_qr_code_create(self, browser,  sign_up_fixture):
    ...
    def test_video_qr_code_create(self, browser,  sign_up_fixture):
    ...
    def test_apps_qr_code_create(self, browser,  sign_up_fixture):
    ...
    def test_coupon_qr_code_create(self, browser,  sign_up_fixture):
    ...
    def test_mp3_qr_code_create(self, browser,  sign_up_fixture):
    ...
    def test_menu_qr_code_create_menu_type(self, browser,  sign_up_fixture):
    ...
    def test_menu_qr_code_create_pdf_type(self, browser,  sign_up_fixture):
    ...
    def test_menu_qr_code_create_link_type(self, browser,  sign_up_fixture):
        self.qr_creation_page.menu_link_qr_create()
        self.my_qr_codes_page.expect(self.my_qr_codes_page.locator.sign_up_success_image).to_be_enabled()

    @allure.title("WiFi QR type")
    def test_wi_fi_qr_code_type(self, browser,  sign_up_fixture):
    ...
    def test_facebook_qr_code_type(self, browser,  sign_up_fixture):
    ...
    def test_instagram_qr_code_type(self, browser,  sign_up_fixture):
    ...
    def test_social_media_qr_code_type(self, browser,  sign_up_fixture):
    ...
    def test_whatsapp_qr_code_type(self, browser,  sign_up_fixture):
