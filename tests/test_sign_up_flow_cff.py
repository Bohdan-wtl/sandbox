...
class TestCFFSignUpFlow(BaseTest):
    ...
    def test_cff_sign_up_website_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_pdf_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_links_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_vcard_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_business_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_image_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_video_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_apps_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_coupon_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_mp3_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_menu_menu_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_menu_pdf_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_menu_link_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_wifi_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_facebook_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_instagram_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_social_media_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
    ...
    def test_cff_sign_up_whats_app_qr_type(self, browser,  navigate_to_dpf_page, fake_email):
