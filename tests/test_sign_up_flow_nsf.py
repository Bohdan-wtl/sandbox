...
class TestNSFSignUpFlow(BaseTest):
    ...
    def test_nsf_sign_up_website_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_pdf_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_links_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_vcard_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_business_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_images_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_video_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_apps_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_coupon_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_mp3_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_menu_menu_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_menu_pdf_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_menu_link_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_wifi_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_facebook_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_instagram_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_social_media_qr_type(self, browser, navigate_to_nsf_page, fake_email):
    ...
    def test_nsf_sign_up_whatsapp_qr_type(self, browser, navigate_to_nsf_page, fake_email):
